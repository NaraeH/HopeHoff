...
----------shopTable insert문-----------------------
	...
	values('124-86-06376','b01','와라와라','서울시 강남구','서울 강남구 역삼동 8221번지 강남A타워 지하1층','02-558-1676','15:00 ~ 05:00','강남 와라와라로 와라와라!','더 세련되어지고 더 아늑해진 우리만의 공간, 고객을 사랑하는 마음으로 기다리겠습니다. 누룽지탕, 해물짬뽕탕, 치즈해물떡볶이 등  맛있어요',	'강남','퓨전술집','퓨전안주');
		

	insert into SHOP(BBNO,UID,SNAME,SINTROADDR,SDETAILADDR,SPHONE,STIME,SINTRO,SINFO,SAREA,STYPE,SSNACK)
	values('203-81-63199','b02','준코','서울시 서초구','서울시 서초구 서초동 1309-5지하 1층','02-595-3235','18:00 ~ 09:00','술마시고 노래하고 춤을춰! 하나가득 준코!','더 세련되어지고 더 아늑해진 우리만의 공간, 고객을 사랑하는 마음으로 기다리겠습니다. 소주, 호프, 안주 판매 및 노래방 운영.','강남','룸형식','퓨전안주');

		
	insert into SHOP(BBNO,UID,SNAME,SINTROADDR,SDETAILADDR,SPHONE,STIME,SINTRO,SINFO,SAREA,STYPE,SSNACK)
	values('408-81-28536','b03','한신포차','서울시 강남구','서울 특별시 강남구 강남대로 8길 11','02-515-3199','18:00 ~ 09:00','한번먹고 두번먹고 자꾸먹고 싶네~',	'전국에 누구나 함께 올수 있는 한신포차,세계인의 입맛을 사로잡은 닭발, 대한민국 대표 포장마차, 휴무일, 주차여부는 매장 상황에 따라 달라질 수 있으니, 매장에 직접 전화하여 확인해 주시기 바랍니다','강남','포차','퓨전안주');
		
	insert into SHOP(BBNO,UID,SNAME,SINTROADDR,SDETAILADDR,SPHONE,STIME,SINTRO,SINFO,SAREA,STYPE,SSNACK)
	values('211-87-14784','b04','칠성포차','서울시 영등포구','서울특별시 영등포구 영등포동3가 9-20','02-2068-8480','18:00 ~ 04:00','일이삼사오육칠성포차! 마약찜닭!','고객은 관객처럼 즐기고, 매장은 무대처럼 가꾸고 , 직원은 배우처럼 일하자. 마약찜닭, 주류 판매, 포장마차 입니다 많이 사랑해주세요. ','영등포','포차','퓨전안주');
		
	insert into SHOP(BBNO,UID,SNAME,SINTROADDR,SDETAILADDR,SPHONE,STIME,SINTRO,SINFO,SAREA,STYPE,SSNACK)
	values('128-31-85241','b04','달동네포차','서울시 영등포구','서울 특별시 영등포구 문래동3가 55-5 로데오왁 1층','02-2676-9911','18:00 ~ 09:00','7,80년대 추억 복고풍의 달동네 포차!','7,80년대 드라마에서 나올만한 테마의 술집 ,영등포 최고의 술집이 되겠습니다.든든한 서비스를 챙겨드리겠습니다.','영등포','포차','퓨전안주');
		
	insert into SHOP(BBNO,UID,SNAME,SINTROADDR,SDETAILADDR,SPHONE,STIME,SINTRO,SINFO,SAREA,STYPE,SSNACK)
	values('220-80-83576','b01','꾼(KKUNNORI)','서울시 강남구','서울시 서초구 서초동 1907-29번지 수호빌딩','02-535-9065','18:00 ~ 09:00','진정한 술꾼은 꾼으로 모여라!','테이블마다 각각의 독립된 공간에서 즐기는 룸타입의 호텔식 퓨전주점 꾼노리입니다.','강남','룸형식','퓨전안주');

	insert into SHOP(BBNO,UID,SNAME,SINTROADDR,SDETAILADDR,SPHONE,STIME,SINTRO,SINFO,SAREA,STYPE,SSNACK)
	values('503-85-21617','b02','삼거리포차','서울시 강남구','서울특별시 서초구 서초동 1308-4 실버타운','02-532-1904','19:00 ~ 06:00','거리도 모인다 우리도 모이자 삼거리포차!','80s와 90s을 오묘하게 이어놓은 촬영장 컨셉의 삼거리포차입니다.','강남','포차','퓨전안주');
	
	insert into SHOP(BBNO,UID,SNAME,SINTROADDR,SDETAILADDR,SPHONE,STIME,SINTRO,SINFO,SAREA,STYPE,SSNACK)
	values('303-90-56632','b03','시바라구','서울시 강남구','서울 특별시 서초구 서초4동 1317-11','02-3477-0777','11:30 ~ 02:00','이자카야 주점은 시바라구! 욕 아니에요.','시바라구는 수제 해산물 전문 주점으로써 매일 싱싱한 재료를 이용하여 최상의 서비스를 제공하고 있습니다. 단체고객을 위한 넓은 좌석이 마련되어 있사오니 많은 이용 부탁드립니다','강남','이자카야','퓨전안주');
